...
import { subscribeToCreatorPlaybook } from "./actions";

export default function CreatorPlaybookSqueezePage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    e.preventDefault();
    setLoading(true);
    const result = await subscribeToCreatorPlaybook(email);
    if (result.success) {
      router.push("/paid-guide/dashboard");
    } else {
      setLoading(false);
    }
  }
